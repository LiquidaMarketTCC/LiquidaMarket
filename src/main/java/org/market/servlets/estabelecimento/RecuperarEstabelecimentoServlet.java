...
@WebServlet("/RecuperarEstabelecimentoServlet")
public class RecuperarEstabelecimentoServlet extends HttpServlet {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 312909878442483648L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {			
			...
			String json = recuperarEstabelecimento(idEstabelecimento);
	...
	private String recuperarEstabelecimento(long idEstabelecimento) throws JsonProcessingException {
